...
{
    public partial class ServicoProdutoTabelaOperadoraClassificacaoProdutoAlternativaHistorico
    {
        public int IdServicoprodutotabelaOperadoraClassificacaoprodutoAlternativaHistorico { get; set; }

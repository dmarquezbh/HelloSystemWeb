...
{
    public partial class ServicoProdutoTabelaPlanoClassificacaoProdutoAlternativaHistorico
    {
        public int IdServicoprodutotabelaPlanoClassificacaoprodutoAlternativaHistorico { get; set; }

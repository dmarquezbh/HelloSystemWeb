...
{
    public partial class ServicoProdutoTabelaOperadoraClassificacaoProdutoGrupoHistorico
    {
        public int IdServicoprodutotabelaOperadoraClassificacaoprodutoGrupoHistorico { get; set; }

...
{
    public partial class ServicoReducaoAcrescimo
    {
        public int IdServicoReducaoAcrescimo { get; set; }
        public int IdServico { get; set; }
        public int? IdOperadora { get; set; }
        public int? IdPlano { get; set; }
        public int? IdUnidadeOrganizacional { get; set; }
        public bool InExterno { get; set; }
        public double? PrHonorario { get; set; }
        public double? PrCustoOperacional { get; set; }
